...
$sts_valid=array('1'=>'VALID','0'=>'TIDAK VALID');
?>
...
<div class="box-body">
  ...
  <div class="row">
	...
	<div class="row">
  <div class="col-md-6"><?=$form->field($model, 'sts_tampil')->widget(Select2::classname(), [
      'data' => $sts_tampil,
      'pluginOptions' => [
        'allowClear' => true
      ],
  ...
  <div class="col-md-6"><?=$form->field($model, 'sts_valid')->widget(Select2::classname(), [
      'data' => $sts_valid,
      'pluginOptions' => [
        'allowClear' => true
      ],
